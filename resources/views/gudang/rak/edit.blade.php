...
<div class="main-container">
    <div class="card">
        <h2 style="margin-bottom: 25px;">Edit Rak untuk Gudang: <strong>{{ $gudang->nama }}</strong></h2>
        ...
        <form action="{{ route('gudang.rak.update', ['gudangId' => $gudang->id, 'rakId' => $rak->id]) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kode_rak" id="kode_rak" value="{{ old('kode_rak', $rak->kode_rak) }}">
                @error('kode_rak')
